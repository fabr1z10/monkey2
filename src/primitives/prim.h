...
//    class Quad {
//    public:
//		// texcoords (all normalized in [0, 1])
//		// 0: x coordinate of top-left point
//		// 1: y coordinate of top-left point
//		// 2: width of quad
//		// 3: height of quad
//        glm::vec4 texCoord;
//        glm::vec2 anchor;
...
//	class QuadPalette {
//	public:
//		// tex coords work same way as standard quad
//		glm::vec4 texCoord;
//		glm::vec2 anchor;
//		glm::vec2 size;
//		//int palIndex;
...
//		QuadPalette() = default;
//
//		QuadPalette(glm::vec4 texCoords, glm::vec2 anchor, glm::vec2 size);//, int paletteIndex);
//
//		/* Constructs a quad from raw data - requires the inverse
//		 * of the size of the texture
//		 */
//		QuadPalette(const float*);
//
//
//		static constexpr GLenum _glPrim = GL_TRIANGLES;
//
...
//		static constexpr int _nIndices = 6;
//
//		static constexpr int _shaderType = 4;
//
//		// 4 texture coordinates, 2 anchor point, and texture index
//		static constexpr int _floatsPerPrimitive = 9;
//
//		static constexpr int _indices[6] = {0, 1, 2, 0, 2, 3};
//
//		using Vertex = VertexTexture;	// we can reuse this vertex -> texindex is palindex
//
//		void transform(VertexTexture*, const glm::mat4& t, int palette) const;
//
//		void clear(VertexTexture*);
//	};
//
